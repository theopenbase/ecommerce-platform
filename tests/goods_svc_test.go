...
func TestGetSpuDetail_Success(t *testing.T) {
	...
	images := []model.SkuImage{{ID: 1, URL: "http://img.jpg"}}
...
func TestUpdateSkuStatus_ValidTransition_Success(t *testing.T) {
	...
	mockRepo.AssertCalled(t, "InvalidateSpuCache", context.Background(), uint64(1))
}
...
func TestBool2Uint8(t *testing.T) {
	...
	for _, tt := range tests {
		result := bool2uint8(tt.cond, tt.fallback)
